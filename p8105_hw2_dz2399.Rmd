...
For available data, the total precipitation in 2017 was `r precip_full[22,2]`. The median number of sports balls in a dumpster in 2016 is `r median(subset(df_tw, year==2016)$sports_balls) `
